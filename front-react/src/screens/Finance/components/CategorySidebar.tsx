import { ShoppingCart, Utensils, Car, Home, Activity, GraduationCap, Shirt, Gamepad2, Plane, Smartphone, Dumbbell, PawPrint, Banknote, TrendingUp, Gift, Wifi, Tv, Tag, Wrench, CreditCard, HelpCircle } from 'lucide-react';
